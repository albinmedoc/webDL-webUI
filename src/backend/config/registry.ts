...
export const REGISTRY = defineRegistry({
  ...
  releaseNameTemplate:   { key: 'releaseNameTemplate',   envVar: 'USENET_RELEASE_NAME_TEMPLATE',    group: 'release',    kind: 'string',  default: '{show}.S{season}E{episode}.{language}.{quality}.WEB-DL.{codec}-{group}' },
